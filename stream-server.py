...
try:
    while True:
        ...
        # should have timestamp at least in name
        cv2.imwrite('test.jpg', image)
        color, grn, red, img = decide_color(img, grn_lower, grn_upper, red_lower, red_upper)
        # TODO: store those in database
        # might be time to move this logic into a branch in the main repo
        print('image written')
